...
class LandsOneStopShopApplication extends Model
{
    ...
    protected $fillable = [
        ...
        'res_addr_plot',
        'res_addr_street',
        'res_addr_street_other',
        'res_addr_district',
        'res_addr_district_other',
        'res_addr_lga',
        'res_addr_state',
        'res_corr_plot',
        'res_corr_street',
        'res_corr_street_other',
        'res_corr_district',
        'res_corr_district_other',
        'res_corr_lga',
        'res_corr_state',
        'res_biz_plot',
        'res_biz_street',
        'res_biz_street_other',
        'res_biz_district',
        'res_biz_district_other',
        'res_biz_lga',
        'res_biz_state',
        'com_corr_plot',
        'com_corr_street',
        'com_corr_street_other',
        'com_corr_district',
        'com_corr_district_other',
        'com_corr_lga',
        'com_corr_state',
        'com_biz_plot',
        'com_biz_street',
        'com_biz_street_other',
        'com_biz_district',
        'com_biz_district_other',
        'com_biz_lga',
        'com_biz_state',
        'ind_corr_plot',
        'ind_corr_street',
        'ind_corr_street_other',
        'ind_corr_district',
        'ind_corr_district_other',
        'ind_corr_lga',
        'ind_corr_state',
        'ind_biz_plot',
        'ind_biz_street',
        'ind_biz_street_other',
        'ind_biz_district',
        'ind_biz_district_other',
        'ind_biz_lga',
        'ind_biz_state',
        // Agricultural
        'agr_corr_plot',
        'agr_corr_street',
        'agr_corr_street_other',
        'agr_corr_district',
        'agr_corr_district_other',
        'agr_corr_lga',
        'agr_corr_state',
        'agr_biz_plot',
        'agr_biz_street',
        'agr_biz_street_other',
        'agr_biz_district',
        'agr_biz_district_other',
        'agr_biz_lga',
        'agr_biz_state',
        // Passport photo
        'passport_photo',

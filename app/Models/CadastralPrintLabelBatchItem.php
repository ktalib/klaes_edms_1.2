...
class CadastralPrintLabelBatchItem extends Model
{
    protected $connection = 'sqlsrv';
    protected $table = 'cadastral_print_label_batch_items';
    ...
    {
        return $this->belongsTo(CadastralPrintLabelBatch::class, 'batch_id');
    }

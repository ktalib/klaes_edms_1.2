...
<div class="flex-1 overflow-auto bg-slate-50 flex flex-col min-h-full">
    @include('admin.header', ['PageTitle' => $PageTitle, 'PageDescription' => 'Manage institutional PHS accounts and token balances.'])
    ...
    <div class="flex-1 p-6">
        <div class="mb-6 rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
            <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        <h2 class="text-lg font-extrabold text-slate-900">Institution Directory</h2>
        ...
        @php
            $statCards = [
                ['label' => 'Institutions', 'value' => $stats['institutions'], 'icon' => 'building-2', 'tone' => 'bg-indigo-50 text-indigo-700 ring-indigo-100'],
        ...
        <div class="overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm">
            <div class="flex items-center justify-between gap-3 border-b border-slate-200 bg-white px-5 py-4">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900">Registered institutions</h3>

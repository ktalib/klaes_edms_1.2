...
@section('page-title')
    {{ __('Digital Signature Control') }}
@endsection

@section('content')
<div class="flex-1 overflow-auto bg-slate-50/60">
    @include('admin.header', [
        'PageTitle'       => 'Digital Signature Control',
        'PageDescription' => 'Manage officers across all departments, their ranks, digital signatures and verification methods.'
    ])
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    ...
                    <h1 class="text-2xl font-extrabold text-slate-900 tracking-tight mt-1">Digital Signature Control</h1>
                    <p class="text-slate-500 text-sm mt-1">Manage officers across all departments, their ranks, digital signatures and verification methods.</p>
                </div>
            ...
            <div id="add-land-officer-card" class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 hidden">
                <div class="flex items-center justify-between mb-5">
                    <h2 class="text-base font-bold text-slate-800">Add Signing Officer</h2>
                ...
                <form id="land-officer-form" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="space-y-1.5">
                            <label class="block text-xs font-semibold text-slate-600 uppercase tracking-wide">Department
                                <span class="text-slate-400 normal-case font-normal tracking-normal">(filter)</span>
                            </label>
                        ...
                        <div class="space-y-1.5">
                            ...
                            <div class="relative">
                                <select id="add-user-id" name="user_id"
                                    class="w-full rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm text-slate-900 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100 outline-none transition">
                        ...
                        <div class="md:col-span-2 flex items-center gap-3 pt-1">
                            <button type="submit" id="save-officer-btn"
                                ...
                                <span id="save-officer-btn-text">Save</span>
                            </button>
            ...
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                <div class="bg-slate-50 px-6 py-4 border-b border-slate-200 flex items-center gap-2">
                    <i data-lucide="pen-tool" class="h-4 w-4 text-emerald-600"></i>
                    <h3 class="font-bold text-slate-800">Signing Officers</h3>
                ...
                <div class="overflow-x-auto">
                    ...
                    <div id="edit-officer-modal" class="hidden fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4">
                        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-xl p-6">
                            <div class="flex items-center justify-between mb-5">
                                <h2 class="text-base font-bold text-slate-800">Edit Signing Officer</h2>
                                ...
                                <tr>
                                    <td colspan="5" class="px-5 py-12 text-center">
                                        <div class="flex flex-col items-center gap-3">
                                            ...
                                            <p class="text-slate-400 text-sm font-medium">No signing officers configured</p>
                                            <p class="text-slate-300 text-xs">Click "Add Signing Officer" to get started.</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
...
(function () {
    ...
    document.getElementById('land-officer-form')?.addEventListener('submit', function (e) {
        ...
        .finally(() => { btn.disabled = false; btnText.textContent = 'Save'; });
    });
    ...
    // Auto-load all users on page init
    loadUsersByDept('0', addUserSel, addSpinner, null, null);
})();
</script>
@endpush
@endsection

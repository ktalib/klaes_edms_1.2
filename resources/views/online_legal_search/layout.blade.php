...
<head>
    ...
    <title>@yield('title', 'Online Legal Search Portal') — KLAES</title>
    ...
    <script>
        (function() {
            const t = localStorage.getItem('ols-theme');
...
<body class="min-h-screen bg-slate-100 dark:bg-gray-900 text-slate-900 dark:text-gray-100 antialiased" style="font-family: Inter, sans-serif;">
    ...
    <script>
        ...
        function olsToggleTheme() {
            const isDark = document.documentElement.classList.toggle('dark');
            localStorage.setItem('ols-theme', isDark ? 'dark' : 'light');

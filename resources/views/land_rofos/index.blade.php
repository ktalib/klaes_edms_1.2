    ...
    <div class="py-12 bg-slate-50 min-h-screen">
        <div class="max-w-[95%] mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                <div>
                    <h1 class="text-3xl font-extrabold text-slate-900 tracking-tight">Lands RofO Management</h1>
                        ...
                        <tbody class="divide-y divide-slate-100 text-sm">
                            ...
                            <tr class="hover:bg-slate-50/50 transition">
                                ...
                                <td class="px-4 py-2 text-center text-slate-500 text-xs whitespace-nowrap">
                                    {{ $rec->approved_at ? $rec->approved_at->format('Y-m-d h:i A') : 'N/A' }}
                                </td>
                                <!-- <td class="px-4 py-2 text-center text-slate-500 text-xs whitespace-nowrap">

    ...
    <div class="py-1 px-3 mb-0.5 border-t border-slate-100">
      <div class="sidebar-module-header flex items-center justify-between py-2 px-3 mb-0.5 cursor-pointer hover:bg-slate-50 rounded-md" data-module="special-assignment">
        ...
        <i data-lucide="chevron-right" class="h-4 w-4 transition-transform duration-200" data-chevron="special-assignment"></i>
      </div>

      <div class="pl-4 mt-1 space-y-0.5 hidden" data-content="special-assignment">
        ...
        <div class="sidebar-submodule-header flex items-center justify-between py-1.5 px-3 cursor-pointer rounded-md" data-section="sa-field-data">
          <div class="flex items-center gap-2">
            <i data-lucide="clipboard-list" class="h-4 w-4 text-[rgb(186,191,12)]"></i>
            <span>Field Data</span>
          </div>
          <i data-lucide="chevron-right" class="h-4 w-4 transition-transform duration-200" data-chevron="sa-field-data"></i>
        </div>
        <div class="pl-4 mt-1 mb-1 space-y-0.5 hidden" data-content="sa-field-data">
          <!-- i. Field Map -->
          <a href="#" class="sidebar-item flex items-center gap-2 py-2 px-3 rounded-md transition-all duration-200">
        ...
        <div class="sidebar-submodule-header flex items-center justify-between py-1.5 px-3 cursor-pointer rounded-md" data-section="sa-bills-payments">
          <div class="flex items-center gap-2">
            <i data-lucide="receipt" class="h-4 w-4 text-[rgb(186,191,12)]"></i>
            <span>Bills &amp; Payments</span>
          </div>
          <i data-lucide="chevron-right" class="h-4 w-4 transition-transform duration-200" data-chevron="sa-bills-payments"></i>
        </div>
        <div class="pl-4 mt-1 mb-1 space-y-0.5 hidden" data-content="sa-bills-payments">
          <!-- i. Bills -->
          <a href="#" class="sidebar-item flex items-center gap-2 py-2 px-3 rounded-md transition-all duration-200">
        ...
        <div class="sidebar-submodule-header flex items-center justify-between py-1.5 px-3 cursor-pointer rounded-md" data-section="sa-notice">
          <div class="flex items-center gap-2">
            <i data-lucide="bell" class="h-4 w-4 text-[rgb(186,191,12)]"></i>
            <span>Notice</span>
          </div>
          <i data-lucide="chevron-right" class="h-4 w-4 transition-transform duration-200" data-chevron="sa-notice"></i>
        </div>
        <div class="pl-4 mt-1 mb-1 space-y-0.5 hidden" data-content="sa-notice">
          <!-- i. First Serve -->
          <a href="#" class="sidebar-item flex items-center gap-2 py-2 px-3 rounded-md transition-all duration-200">
        ...
        <!-- e. Other Departments (collapsible) -->
        @if($hasRole('Special Assignment - Other Departments') || $hasRole('Supper Admin'))
        <div class="sidebar-submodule-header flex items-center justify-between py-1.5 px-3 cursor-pointer rounded-md" data-section="sa-other-departments">
          <div class="flex items-center gap-2">
            <i data-lucide="building-2" class="h-4 w-4 text-[rgb(186,191,12)]"></i>
            <span>Other Departments</span>
          </div>
          <i data-lucide="chevron-right" class="h-4 w-4 transition-transform duration-200" data-chevron="sa-other-departments"></i>
        </div>
        <div class="pl-4 mt-1 mb-1 space-y-0.5 hidden" data-content="sa-other-departments">
          <!-- i. Cadastral -->
          <a href="#" class="sidebar-item flex items-center gap-2 py-2 px-3 rounded-md transition-all duration-200">
            <i data-lucide="layout-grid" class="h-3.5 w-3.5 text-[rgb(186,191,12)]"></i>
            <span>Cadastral</span>
          </a>
          <!-- ii. Physical Planning/KNUPDA -->
          <a href="#" class="sidebar-item flex items-center gap-2 py-2 px-3 rounded-md transition-all duration-200">

    ...
    <div class="py-1 px-3 mb-0.5 border-t border-slate-100">
      ...
      <a href="{{ route('system-admin.phs.index') }}" class="sidebar-item flex items-center gap-2 py-2 px-3 rounded-md transition-all duration-200 {{ request()->routeIs('system-admin.phs.*') ? 'active' : '' }}">
        <i data-lucide="building-2" class="h-3.5 w-3.5 text-cyan-400"></i>

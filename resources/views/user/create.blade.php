    ...
    <div class="mx-auto w-full">
        <div class="bg-white rounded-lg overflow-hidden">
            ...
            <div class="p-6 overflow-y-auto max-h-[80vh]" x-data="{
                ...
                leaveStartDate: @json(old('leave_start_date')),
                leaveEndDate: @json(old('leave_end_date')),
                    ...
                    @if (\Auth::user()->type != 'super admin')
                        <div class="w-full px-3">
                            ...
                            <div class="mb-6 space-y-5 rounded-lg border border-gray-200 bg-gray-50 p-6">
                                ...
                                <div class="mb-4 p-4 rounded-lg border border-amber-200 bg-amber-50">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="flex items-start space-x-3">
                                            {{ Form::checkbox('is_on_leave', 1, old('is_on_leave', false), [
                                    ...
                                    <div class="grid gap-4 md:grid-cols-2">
                                        <div>
                                            ...
                                            {{ Form::date('leave_start_date', old('leave_start_date'), [
                                        ...
                                        <div>
                                            ...
                                            {{ Form::date('leave_end_date', old('leave_end_date'), [
                                                'class' => 'w-full rounded-md border border-gray-300 p-2 text-sm',
                                    ...
                                    <div class="grid gap-4 md:grid-cols-2">
                                        <div>
                                            ...
                                            {{ Form::select('deputy_user_id', $deputyOptions ?? [], old('deputy_user_id'), [
                                        ...
                                        <div>
                                            ...
                                            {{ Form::text('leave_reason', old('leave_reason'), [
                                                'class' => 'w-full rounded-md border border-gray-300 p-2 text-sm',
                                    ...
                                    <div class="w-full md:w-1/2 px-2 mb-2">
                                        <div>
                                            ...
                                            <select name="rank" id="rank" onchange="toggleRankOther(this)"
                                                ...
                                                @endforeach
                                                <option value="__other__" {{ old('rank') === '__other__' ? 'selected' : '' }}>Other (specify)…</option>
                                            </select>
                                            <input type="text" name="rank_other" id="rank_other" value="{{ old('rank_other') }}"
                                                placeholder="Enter new rank title"
                                                class="w-full mt-2 p-2 border border-blue-300 rounded-md text-sm focus:ring-blue-500 focus:border-blue-500 {{ old('rank') === '__other__' ? '' : 'hidden' }}">
                            ...
                            <div class="mt-6" id="roles_container">
                                            ...
                                            <div class="flex items-start role-item"
                                                ...
                                                <div class="flex items-center h-5">
                                                    <input type="checkbox" name="user_role[]" value="{{ $role->name }}"
                                                        ...
                                                        @if($role->name === 'Log a File') id="role_log_a_file_create" @endif>
                                                </div>
                                ...
                                <div id="dfr-modal-create" class="hidden fixed inset-0 z-[9999] flex items-center justify-center p-4">
                                    {{-- Backdrop --}}
                                    <div id="dfr-modal-backdrop-create" class="absolute inset-0 bg-black/50"></div>
                                    {{-- Dialog --}}
                                    <div class="relative w-full max-w-md rounded-2xl bg-white shadow-2xl overflow-hidden">
                                        ...
                                        <div class="bg-gradient-to-r from-[#450a0a] via-[#6b1010] to-[#450a0a] px-5 py-4 flex items-center gap-3">
                                            ...
                                            <button type="button" id="dfr-modal-close-create" class="ml-auto text-red-200 hover:text-white transition">
                                        ...
                                        <div class="p-5 space-y-3">
                                            <label class="flex items-center gap-3 p-3 rounded-xl border border-gray-200 bg-gray-50 hover:border-red-300 hover:bg-red-50 cursor-pointer transition">
                                                <input type="checkbox" name="dfr_permissions[]" value="view_requests" id="dfr_view_requests_create"
                                            ...
                                            <label class="flex items-center gap-3 p-3 rounded-xl border border-gray-200 bg-gray-50 hover:border-red-300 hover:bg-red-50 cursor-pointer transition">
                                                <input type="checkbox" name="dfr_permissions[]" value="approve_request" id="dfr_approve_request_create"
                                                    class="h-4 w-4 rounded border-gray-300 text-[#450a0a] focus:ring-red-400">
                                                <div>
                                ...
                                <script>
                                (function () {
                                    function initDfrModalCreate() {
                                        var cb       = document.getElementById('role_log_a_file_create');
                                        var modal    = document.getElementById('dfr-modal-create');
                                        var backdrop = document.getElementById('dfr-modal-backdrop-create');
                                        var btnDone  = document.getElementById('dfr-modal-done-create');
                                        var btnCancel= document.getElementById('dfr-modal-cancel-create');
                                        var btnClose = document.getElementById('dfr-modal-close-create');
                                        if (!cb || !modal) return;
                                    ...
                                    if (document.readyState === 'loading') {
                                        document.addEventListener('DOMContentLoaded', initDfrModalCreate);
                                    } else {
                                        initDfrModalCreate();
                                    }
                                })();

    ...
    <div class="p-6">
        ...
        <div class="bg-white rounded-md shadow-sm border border-gray-200 p-6">
            ...
            <div class="flex justify-between items-center mb-6">
                <h2 class="text-xl font-bold">Survey Records</h2>
                <!-- Survey Create Button -->
                <a href="{{ route('survey_record.create', ['is' => 'primary']) }}" 
                   id="survey-create-button"
                   class="flex items-center space-x-2 px-4 py-2 bg-green-700 text-white rounded-md hover:bg-green-800">
                    <i data-lucide="file-plus" class="w-4 h-4"></i>
                    <span>Create New Survey Record</span>
                </a>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 mb-8">
                ...
                <div class="counter-card primary rounded-xl p-6 text-white shadow-lg">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-white/80 text-sm font-medium">Total Survey Records</p>
                            <p class="text-3xl font-bold mt-2" id="total-counter">{{ count($surveys) }}</p>
                            <p class="text-white/70 text-xs mt-1">All survey data</p>
                        </div>
    ...
    <div class="relative top-20 mx-auto p-5 border w-11/12 md:w-3/4 lg:w-1/2 shadow-lg rounded-md bg-white">
        <div class="mt-3">
            ...
            <div class="flex items-center justify-between pb-3 border-b">
                <h3 class="text-lg font-bold text-gray-900" id="modalTitle">Survey Plan</h3>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        exportBtn.addEventListener('click', function() {
            ...
            a.href = url;
            a.download = `survey-records-${new Date().toISOString().split('T')[0]}.csv`;
    ...
    window.toggleDropdown = function(surveyId) {
        ...
        dropdown.innerHTML = `
            <a href="{{ url('survey_record/edit') }}/${surveyId}" 
    ...
    window.confirmDelete = function(surveyId) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                form.method = 'POST';
                form.action = `{{ url('survey_record/delete') }}/${surveyId}`;
    ...
    window.viewSurveyPlan = function(surveyId, fileNo, planPath) {
        ...
        // Set modal title
        modalTitle.textContent = `Survey Plan`;
        ...
        if (planPath && planPath !== '') {
            ...
            if (['jpg', 'jpeg', 'png', 'gif'].includes(fileExtension)) {
                ...
                planContent.innerHTML = `
                    <div class="max-w-full max-h-96 overflow-auto">
                        <img src="${fullPath}" alt="Survey Plan" class="max-w-full h-auto mx-auto rounded-lg shadow-md">
                    </div>
                `;
            ...
            planContent.innerHTML = `
                <div class="text-center py-8">
                    ...
                    <h4 class="text-lg font-semibold text-gray-700 mb-2">No Survey Plan Available</h4>
                    <p class="text-gray-500">No survey plan has been uploaded for this record.</p>
                </div>
            `;

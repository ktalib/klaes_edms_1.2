...
<script>
    ...
    function toggleFileNoInput(projectType) {
        ...
        if (projectType && projectType !== 'Ministry') {
            ...
            // Only clear for a new project; keep an existing project's manual FileNo on edit.
            if (!isEdit) {
                $fileno.val('');
            ...
            // Restore the auto-generated FileNo when returning to Ministry (new projects only).

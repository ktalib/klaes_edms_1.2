<div class="p-6">
    <div class="container mx-auto py-6 space-y-6">
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
                <h1 class="text-3xl font-bold">ST Print File Labels</h1>
                <p class="text-gray-600 mt-1">Generate and print labels for ST (Sectional Titling) physical files</p>
            </div>
        ...
        <div class="w-full">
            ...
            <div id="files-tab" class="tab-content active mt-6">
                <div class="bg-white rounded-lg border">
                    ...
                    <div class="p-6">
                        {{-- ST Batch Number + Rack/Shelf Selectors --}}
                    ...
                    <div class="p-6 border-b">
                        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                            <div>
                                ...
                                <p class="text-sm text-gray-600">View and manage generated ST label batches</p>
                            </div>
                            <div class="flex gap-2">
                                <input
                                    type="text"
            ...
            {{-- ====== PREVIEW & PRINT TAB ====== --}}
            @include('st_printlabel.partials.preview')
        </div>
    </div>
</div>

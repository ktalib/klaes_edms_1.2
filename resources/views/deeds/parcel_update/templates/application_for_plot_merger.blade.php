...
<head>
  ...
  <title>Plot Merger Application - {{ $record->file_no ?? '' }}</title>
  <style>
...
<div class="page">
  ...
  {{-- BODY --}}
  <div class="para">
    At page 1 is an application for Plot Merger in respect of the property covered by <strong>{{ $record->file_no ?? '...............' }}</strong> over a piece of land situated at
  ...
  <div class="rec-block">
    <div class="para">
      I. <strong>CONSIDER AND APPROVE</strong> the merger in respect of <strong>{{ $record->file_no ?? '...............' }}</strong> over a piece of land situated at

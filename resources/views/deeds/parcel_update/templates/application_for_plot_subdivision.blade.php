...
<head>
  ...
  <title>Plot Subdivision Application - {{ $record->file_no ?? '' }}</title>
  <style>
...
<div class="page">
  ...
  {{-- BODY --}}
  <div class="para">
    At page 1 is an application for private layout in respect of the property covered by <strong>{{ $record->file_no ?? '...............' }}</strong> over a piece of land situated at
    {{ $record->house_no ? $record->house_no.', ' : '' }}{{ $record->street_name ?? '...............' }}, {{ $record->district ?? '...............' }}, {{ $record->lga ?? '...............' }}
    by the title holder{{ isset($record->applicant_name) && str_contains(strtolower($record->applicant_name), 'ltd') ? 's' : '' }}: <strong>{{ $record->applicant_name ?? '...............' }}</strong>.
  </div>

  <div class="para">
    The application was forwarded to the State Planning Authority for planning advice; consequently the Authority via its memo at page &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; recommended the application for the subdivision of the property into <strong>{{ $record->num_plots ? $record->num_plots.'nos. Portions' : '...... nos. Portions' }}</strong>, in view of the fact that, each portion is independently accessible and conforms with the existing land use of the area.
  </div>

  <div class="para">
    The recommended site plan at page &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; and back cover has the following dimension:-
  </div>
  ...
  <div class="dimension-table">
    ...
    @else
      ...
      <div class="dimension-row"><span class="dim-num">ii.</span><span class="dim-val">..............m x ..............m</span><span class="dim-count">&mdash; ......No.</span></div>
      <div class="dimension-row"><span class="dim-num">iii.</span><span class="dim-val">..............m x ..............m</span><span class="dim-count">&mdash; ......No.</span></div>
    @endif
  </div>
  ...
  <div class="rec-block">
    <div class="para">
      I. <strong>CONSIDER AND APPROVE</strong> the sub-division in respect <strong>{{ $record->file_no ?? '...............' }}</strong> over a piece of land situated at
      {{ $record->street_name ?? '...............' }}, {{ $record->district ?? '...............' }}
      into <strong>{{ $record->num_plots ?? '......' }}nos. Portions</strong> in favour of <strong>{{ $record->applicant_name ?? '...............' }}</strong>.
    </div>
    <div class="para">
      II. Endorse the recommended layout plan No. <strong>{{ $record->knupda_remarks ?? 'PL/KNUPDA/........../.........' }}</strong> at back cover.
    </div>
  </div>

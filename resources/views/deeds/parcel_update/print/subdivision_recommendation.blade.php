    ...
    <div class="a4-page">
        ...
        <div class="main-container">
            ...
            <div class="body-paragraph">
                At Page 1 is an application for <span class="bold-caps">PLOT SUBDIVISION</span> over a piece of land situated <span class="bold-caps">{{ Str::upper($record->location ?: $record->district) }}</span> covered by Certificate of occupancy no. <span class="bold-caps">{{ Str::upper($record->file_no) }}</span> in favour of <span class="bold-caps">{{ Str::upper($record->applicant_name) }}.</span>
            </div>
            <div class="body-paragraph">
                The application seeks to subdivide the aforementioned property into <span class="bold-caps">{{ $record->num_plots }}</span> plots. Verification at Cadastral and Deeds Departments confirms that the title is free from encumbrances and suitable for the proposed subdivision.
            </div>
            <div class="body-paragraph">
            ...
            <div class="point-block">
                a.) Subdivision of plot no. <span class="bold-caps">{{ Str::upper($record->plot_no) }}</span> into {{ $record->num_plots }} parcels as per the attached plan in favor of {{ Str::upper($record->applicant_name) }}.
            </div>

...
<head>
    ...
    <title>Subdivision Application - KLAES GIS</title>
    <style>
        :root {
            --page-color: #fdf6e3;
            --accent-red: #cc0000;
    ...
    <div class="a4-page">
        ...
        <div class="main-container">
            ...
            <div class="body-paragraph">
                This is an application for <span class="bold-caps">PLOT SUBDIVISION</span> over a piece of land situated <span class="bold-caps">{{ Str::upper($record->location ?: $record->district) }}</span> covered by Certificate of occupancy no. <span class="bold-caps">{{ Str::upper($record->file_no) }}</span> in favour of <span class="bold-caps">{{ Str::upper($record->applicant_name) }}.</span>
            </div>
            <div class="body-paragraph">
                The application seeks to subdivide the aforementioned property into <span class="bold-caps">{{ $record->num_plots }}</span> plots.
            </div>
            <div class="body-paragraph">
                In view of the above, please process this application for Subdivision and forward for necessary recommendation:
            </div>

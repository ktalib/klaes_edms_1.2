    ...
    <div class="a4-page">
        ...
        <div class="main-container">
            ...
            <div class="body-paragraph">
                At Page 1 is an application for <span class="bold-caps">PLOT MERGER</span> over properties situated <span class="bold-caps">{{ Str::upper($record->district) }}</span> covered by Certificate of occupancy no. <span class="bold-caps">{{ Str::upper($record->file_no) }}</span> in favour of <span class="bold-caps">{{ Str::upper($record->applicant_name) }}.</span>
            </div>
            <div class="body-paragraph">
                The application seeks to merge <span class="bold-caps">{{ $record->num_plots }}</span> adjacent plots into a single title. Verification at Cadastral and Deeds Departments confirms that the titles are free from encumbrances and suitable for the proposed merger.
            </div>
            <div class="body-paragraph">
            ...
            <div class="point-block">
                a.) Merger of {{ $record->num_plots }} plots as described in the application into a unified title in favor of {{ Str::upper($record->applicant_name) }}.
            </div>

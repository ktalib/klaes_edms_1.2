        ...
        <div class="border border-gray-200 rounded-lg p-4 mb-4 bg-white buyer-row" data-index="${index}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="records[${index}][cubicMeasurement]" class="w-full py-2 px-3 border border-gray-300 rounded-md text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all shadow-sm" placeholder="e.g. 50">
                </div>
            </div>
        </div>
    `;

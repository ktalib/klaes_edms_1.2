    ...
    <div class="container mx-auto py-6 space-y-6 px-4">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div class="flex space-x-2">
                ...
                @if(!empty($application->prop_id))
                <button type="button"
                    onclick="openPropertyTimeline('{{ $application->prop_id }}', '{{ $application->fileno ?? '' }}')"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <span class="inline-block px-3 py-1 rounded-full bg-green-100 text-green-800 font-semibold text-sm mt-1">
                                {{ isset($application->deeds_date) ? date('F j, Y', strtotime($application->deeds_date)) : (isset($application->instrumentDate) ? date('F j, Y', strtotime($application->instrumentDate)) : 'N/A') }}
                            </span>
                        </div>
                        <div>

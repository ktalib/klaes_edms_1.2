              ...
              <div class="space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                  <div class="space-y-1">
                    ...
                    <select id="landUse" name="land_use" x-model="landUse" class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-600/10">

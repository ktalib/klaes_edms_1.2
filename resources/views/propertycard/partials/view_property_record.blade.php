        ...
        <div id="property-view-content" class="space-y-6 max-h-[75vh] overflow-y-auto">
            ...
            <div class="bg-white p-4 rounded-lg border">
                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <p class="text-sm text-gray-500">TP No</p>
                            <p id="view-tp-no" class="font-medium"></p>
                        </div>
                        <div>
                            <p class="text-sm text-gray-500">LPKN No</p>
                            <p id="view-lpkn-no" class="font-medium"></p>
                        </div>
                    </div>

                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <p class="text-sm text-gray-500">Approved Plan No</p>
                            <p id="view-approved-plan-no" class="font-medium"></p>
                        </div>
                        <div>
                            <p class="text-sm text-gray-500">Plot Size</p>
                            <p id="view-plot-size" class="font-medium"></p>
                        </div>
                    </div>

                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <p class="text-sm text-gray-500">Date Recommended</p>
                            <p id="view-date-recommended" class="font-medium"></p>
                        </div>
                        <div>
                            <p class="text-sm text-gray-500">Date Approved</p>
                            <p id="view-date-approved" class="font-medium"></p>
                        </div>
                    </div>

                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <p class="text-sm text-gray-500">Lease Begins</p>
                            <p id="view-lease-begins" class="font-medium"></p>
                        </div>
                        <div>
                            <p class="text-sm text-gray-500">Lease Expires</p>
                            <p id="view-lease-expires" class="font-medium"></p>
                        </div>
                    </div>

                    <div>
                        <p class="text-sm text-gray-500">Metric Sheet</p>
                        <p id="view-metric-sheet" class="font-medium"></p>
                    </div>
                </div>
            </div>
...
<script>
    ...
    function displayPropertyDetails(property) {
        ...
        // Set additional property details (new fields)
        document.getElementById('view-tp-no').textContent = property.tp_no || 'Not specified';
        document.getElementById('view-lpkn-no').textContent = property.lpkn_no || 'Not specified';
        document.getElementById('view-approved-plan-no').textContent = property.approved_plan_no || 'Not specified';
        document.getElementById('view-plot-size').textContent = property.plot_size || 'Not specified';
        document.getElementById('view-date-recommended').textContent = property.date_recommended ? new Date(property.date_recommended).toLocaleDateString() : 'Not specified';
        document.getElementById('view-date-approved').textContent = property.date_approved ? new Date(property.date_approved).toLocaleDateString() : 'Not specified';
        document.getElementById('view-lease-begins').textContent = property.lease_begins ? new Date(property.lease_begins).toLocaleDateString() : 'Not specified';
        document.getElementById('view-lease-expires').textContent = property.lease_expires ? new Date(property.lease_expires).toLocaleDateString() : 'Not specified';
        document.getElementById('view-metric-sheet').textContent = property.metric_sheet || 'Not specified';

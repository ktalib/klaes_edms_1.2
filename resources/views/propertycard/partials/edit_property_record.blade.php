                        ...
                        <div class="space-y-3">
                            ...
                            <div class="form-section">
                                ...
                                <div class="space-y-3 all-tabs-visible">
                                    ...
                                    <input type="hidden" id="edit_property_NewKANGISFileno" name="NewKANGISFileno"
                                        value="">
                                    <input type="hidden" id="edit_property_activeFileTab" name="activeFileTab"
                                        value="mlsFNo">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="space-y-3">
                            <div class="space-y-1">
                                ...
                                <textarea id="edit_property_description" name="property_description" rows="4"
                                    class="form-input text-sm" placeholder="Enter property description"></textarea>
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                <div>
                                    ...
                                    <input id="edit_lgsaOrCity" name="lgsaOrCity" type="text"
                                        class="form-input text-sm">
                                </div>
                                <div>
                                    <label for="edit_plotNo" class="text-xs text-gray-600">Plot No.</label>
                                    <input id="edit_plotNo" name="plot_no" type="text" class="form-input text-sm"
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <div class="space-y-1">
                                ...
                                <select id="edit_transactionType" name="transactionType"
                                    class="form-select text-sm transaction-type-select">
                        ...
                        <div class="space-y-1">
                            ...
                            <div class="grid grid-cols-3 gap-2">
                                <div>
                                    ...
                                    <input id="edit_serialNo" name="serialNo" class="form-input text-sm"
                                        placeholder="e.g. 1" type="number" min="1">
                                </div>
                                <div>
                                    <label for="edit_pageNo" class="text-xs">Page No.</label>
                                    <input id="edit_pageNo" name="pageNo" class="form-input text-sm"
                                        placeholder="e.g. 1" type="number" min="1">
                                </div>
                                <div>
                                    <label for="edit_volumeNo" class="text-xs">Volume No.</label>
                                    <input id="edit_volumeNo" name="volumeNo" class="form-input text-sm"
                                        placeholder="e.g. 2" type="number" min="1">
                                </div>
                            </div>
                            <div id="edit_regNoPreview"
                                class="mt-1 p-1.5 bg-green-50 border border-green-100 rounded-md hidden">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            ...
                            <div class="space-y-1">
                                ...
                                <div class="flex space-x-1">
                                    <input id="edit_period" name="period" type="number" class="form-input text-sm"
                                        placeholder="Period">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (editSerialNo) {
            editSerialNo.addEventListener('input', function() {
                if (this.value.startsWith('0')) {
                    this.value = stripLeadingZeros(this.value);
                }
                updateEditRegNoPreview();
            });
            editSerialNo.addEventListener('blur', function() {
                this.value = stripLeadingZeros(this.value);
                updateEditRegNoPreview();
            });
        }
        if (editPageNo) {
            editPageNo.addEventListener('input', function() {
                if (this.value.startsWith('0')) {
                    this.value = stripLeadingZeros(this.value);
                }
                updateEditRegNoPreview();
            });
            editPageNo.addEventListener('blur', function() {
                this.value = stripLeadingZeros(this.value);
                updateEditRegNoPreview();
            });
        }
        if (editVolumeNo) {
            editVolumeNo.addEventListener('input', function() {
                if (this.value.startsWith('0')) {
                    this.value = stripLeadingZeros(this.value);
                }
                updateEditRegNoPreview();
            });
            editVolumeNo.addEventListener('blur', function() {
                this.value = stripLeadingZeros(this.value);
                updateEditRegNoPreview();
            });
        }

    ...
    <div class="p-6">
        <div class="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
            ...
            <div class="flex justify-between items-center mb-6">
                <h2 class="text-xl font-bold">Edit Cadastral Record</h2>
            ...
            <form id="edit-cadastral-form" method="POST" action="{{ route('survey_cadastral.update-survey') }}" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="id" value="{{ $survey->ID }}">
                
                <div class="space-y-6">
                    <h3 class="text-lg font-medium">
                        Edit {{ $survey->survey_type ?? 'Cadastral' }} Details
                    </h3>
                    
                    @if(isset($survey->survey_type) && $survey->survey_type == 'Unit Survey')
                        @include('survey_cadastral.unit_form', ['survey' => $survey])
                    @endif
                    ...
                    <div class="border border-gray-200 rounded-lg p-4 bg-gray-50">
                        <h4 class="text-sm font-medium mb-3 text-green-600">Cadastral Plan Document</h4>
                        <div class="space-y-3">
                            ...
                            <div>
                                <label for="survey_plan_path" class="block text-sm font-medium text-gray-700 mb-1">
                                    {{ !empty($survey->survey_plan_path) ? 'Replace Cadastral Plan' : 'Upload Cadastral Plan' }}
                                </label>

    ...
    <div class="a4-page">
        ...
        <div class="main-container">
            ...
            <div class="body-paragraph">
                At Page 1 is an application for <span class="bold-caps">PLOT EXTENSION</span> over a piece of land situated <span class="bold-caps">{{ Str::upper($record->location) }}</span> covered by Certificate of occupancy no. <span class="bold-caps">{{ Str::upper($record->file_no) }}</span> in favour of <span class="bold-caps">{{ Str::upper($record->applicant_name) }}.</span>
            </div>
            <div class="body-paragraph">
                The application seeks to extend the existing boundaries of the plot. Verification at Cadastral Department reveals that the proposed extension is feasible and does not infringe on neighboring titles.
            </div>
            <div class="body-paragraph">

...
<script>
    ...
    window.closeCaptureOpModal = function () {
        ...
        // The card is usually opened over another modal, which must keep the scroll lock. But
        // commissioned-file mode can be entered with nothing behind it, and unlocking has to
        // happen there or the page is left unscrollable.
        const behind = ['opBatchModal', 'generateModal']
            .map(id => document.getElementById(id))
            .some(el => el && !el.classList.contains('hidden'));
        document.body.style.overflow = behind ? 'hidden' : '';

<div class="p-6">
    <div class="container mx-auto py-6 space-y-6">
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
                <h1 class="text-3xl font-bold">DCIV Print File Labels</h1>
                <p class="text-gray-600 mt-1">Generate and print labels for DCIV / LPCC physical files</p>
            </div>
        ...
        <div class="w-full">
            ...
            <div id="files-tab" class="tab-content active mt-6">
                <div class="bg-white rounded-lg border">
                    <div class="p-6 border-b bg-gradient-to-r from-slate-50 to-white">
                        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                            <div>
                                <h3 class="text-lg font-semibold">Select DCIV / LPCC Files for Labels</h3>
                                <p class="text-sm text-gray-600">Choose a prefix and enter a batch number to load files from dciv_grouping</p>
                            </div>
                    ...
                    <div class="p-6">
                        {{-- DCIV Prefix + Batch Number + Rack/Shelf Selectors --}}
                        <div class="rounded-lg border border-blue-200 bg-blue-50/30 px-4 py-4 mb-6">
                            <div class="grid grid-cols-1 gap-4 lg:grid-cols-6">
                                <div class="flex flex-col">
                                    ...
                                    <select
                                        id="dcivPrefixSelect"
                                        class="mt-1 w-full rounded-md border border-gray-300 px-3 py-2 text-sm font-semibold focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-200"
                                    >
                                        <option value="DCIV">DCIV</option>
                                        <option value="LPCC">LPCC</option>
                                    </select>
                                    <span class="mt-1 text-xs text-slate-500">Select DCIV or LPCC.</span>
                                </div>
                                <div class="flex flex-col">
                                    <span class="text-xs font-semibold uppercase tracking-wide text-slate-600">Batch Number</span>
                                    <input
                                        type="number"
                                        id="dcivBatchNoInput"
                                        min="1"
                                    ...
                                    />
                                    <span class="mt-1 text-xs text-slate-500">The <code>sys_batch_no</code> from dciv_grouping.</span>
                                </div>
                                <div class="flex flex-col">
                            ...
                            <div class="mt-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                                <div class="text-xs text-slate-500 sm:text-left">
                                    Select a prefix, enter a batch number, then click <strong>Load Records</strong> to fetch files from dciv_grouping.
                                </div>
                                <button
                                    id="generateBatchBtn"
                                    class="inline-flex items-center justify-center rounded-md bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700"
                        ...
                        <div id="fileList" class="rounded-md border">
                            ...
                            <div class="divide-y max-h-96 overflow-y-auto" id="fileListContent">
                                <div class="p-8 text-center text-gray-500">
                                    ...
                                    <p class="text-xs text-gray-400 mt-1">Select a prefix, enter a batch number and click Load Records.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-6 border-b">
                        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                            <div>
                                ...
                                <p class="text-sm text-gray-600">View and manage generated DCIV / LPCC label batches</p>
                            </div>
                            <div class="flex gap-2">
                                <input
                                    type="text"
            ...
            {{-- ====== PREVIEW & PRINT TAB ====== --}}
            @include('dciv_printlabel.partials.preview')
        </div>
    </div>
</div>

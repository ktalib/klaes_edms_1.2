...
<style>
  @media print {
            ...
            /* Force A4 size with appropriate dimensions */
            .print-container {
                ...
                <div class="max-w-4xl mx-auto bg-white shadow-md my-8 print-container">
                    ...
                    <div class="p-8">
                        ...
                        <div class="mb-6">
                            ...
                            <p>Property Name: <strong>{{ $application->commercial_type ?? $application->industrial_type ?? $application->ownership_type ?? $application->residence_type ?? 'N/A' }}</strong></p>
                            <p>Applicant Name: 
                                <strong>
                        ...
                        <div class="mb-6">
                            ...
                            <p>Plot Number: <strong>{{ $application->property_plot_no ?? 'N/A' }}</strong></p>
                            <p>Block Number: <strong>{{ $surveyRecord->block_no ?? 'N/A' }}</strong></p>
                            <p>LGA: <strong>{{ $application->property_lga ?? 'N/A' }}</strong></p>
                        ...
                        <!-- Signature Section -->
                        <div class="mt-8 mb-4 no-break signature-section">

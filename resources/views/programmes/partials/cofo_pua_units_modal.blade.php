<div class="p-4 space-y-4">
    <div class="flex items-start justify-between gap-4">
        <div>
            <h3 class="text-lg font-semibold text-gray-800">PuA Overview (CofO)</h3>
            <div class="text-sm text-gray-600 leading-relaxed">
                ...
                <div class="mt-2 flex flex-wrap gap-3 text-xs">
                    ...
                    <span class="px-3 py-1 bg-amber-100 text-amber-700 rounded-full">CofO: {{ $stats['cofo_generated'] ?? 0 }} / {{ $stats['total_units'] ?? 0 }}</span>
                </div>
            </div>
        </div>

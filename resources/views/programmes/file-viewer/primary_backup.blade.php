        ...
        <div class="content-card">
            ...
            <div class="p-6">
                ...
                <div class="application-summary">
                    <h3 class="text-xl font-bold mb-4 text-gray-800">Application Summary</h3>
                    <div class="summary-grid">
                        ...
                        <div class="summary-item">
                            <span class="summary-label">File Number</span>
                            <span class="summary-value">{{ $application->fileno ?? 'N/A' }}</span>
                        </div>
                        <div class="summary-item">
                            <span class="summary-label">ST File Number</span>
                            <span class="summary-value">{{ $application->np_fileno ?? 'N/A' }}</span>
                        </div>
                        <div class="summary-item">
                            <span class="summary-label">Land Use</span>
                            <span class="summary-value">{{ $application->land_use ?? 'N/A' }}</span>
                        </div>
                        <div class="summary-item">
                            <span class="summary-label">Property Location</span>
                            <span class="summary-value">{{ $application->property_street_name ?? 'N/A' }}, {{ $application->property_lga ?? 'N/A' }}</span>
                        </div>
                        <div class="summary-item">
                            <span class="summary-label">Application Status</span>
                            <span class="summary-value">{{ $application->application_status ?? 'N/A' }}</span>
                        </div>
                        @if($fileIndexing)
                        <div class="summary-item">

...
<head>
  ...
  <title>KANGIS Print File Labels</title>
...
<body>
  <div class="label-document" id="labelDocument">
    <header class="document-header no-print" id="documentHeader">
      <h1>KANGIS Print File Labels</h1>
  ...
  <script>
    (function () {
      const LABELS_PER_PAGE = 25;  // 50 files per batch = 2 pages of 25 labels (5x5 grid)

...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function renderBatchList() {
        ...
        state.generatedBatches.forEach(function(b){
            ...
            var drBadge=b.digit_rank?'<span class="ml-1 font-bold text-slate-600">-'+b.digit_rank+'</span>':'';
            html+='<div class="p-3 grid grid-cols-7 gap-4 hover:bg-gray-50"><div class="font-medium">'+b.batch_number+drBadge+'</div><div class="text-sm">'+dt+'</div><div class="text-sm">'+fc+'</div><div class="text-sm">QR Code</div><div><span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium '+sc+'">'+(b.status.charAt(0).toUpperCase()+b.status.slice(1))+'</span></div><div class="text-sm">'+cn+'</div><div class="flex gap-1"><button onclick="viewBatchDetails('+b.id+')" class="p-1 text-blue-600 hover:text-blue-800" title="View"><i data-lucide="eye" class="h-4 w-4"></i></button>';

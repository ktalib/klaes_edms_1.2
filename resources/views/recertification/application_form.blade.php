...
<div id="new-recertification-modal" class="fixed inset-0 z-50 flex items-center justify-center modal-backdrop"
  style="display: none;">
              ...
              <div class="grid grid-cols-12 gap-4">
                <div class="col-span-9 space-y-4">
                  <div class="form-field">
                    ...
                    <input type="date" id="applicationDate" name="applicationDate" required value="{{ date('Y-m-d') }}"
                  ...
                  <div class="grid grid-cols-2 gap-4">
                    <div class="form-field">
                      <label for="lgaOfOrigin" class="block text-sm font-medium text-gray-700 mb-1">LGA of
                        Origin</label>
                      <input type="text" id="lgaOfOrigin" name="lgaOfOrigin"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm transition-all focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-600/10 uppercase"
                ...
                <div class="col-span-3">
                  <div class="photo-upload-area">
                    ...
                    <button type="button"
                      class="inline-flex items-center justify-center rounded-md font-medium text-sm px-3 py-1.5 transition-all cursor-pointer bg-transparent border border-gray-300 text-gray-700 hover:bg-gray-50">
                      Upload Photo
                    </button>
              ...
              <div>
                ...
                <div class="space-y-4">
                  <div class="grid grid-cols-3 gap-4">
                    ...
                    <div class="form-field">
                      <label for="whatsappPhoneNo" class="block text-sm font-medium text-gray-700 mb-1">Whatsapp Phone
                        No</label>
                      <input type="tel" id="whatsappPhoneNo" name="whatsappPhoneNo"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm transition-all focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-600/10"
                        placeholder="WhatsApp Number" />
                    </div>

                    <div class="form-field">
                      <label for="alternatePhoneNo" class="block text-sm font-medium text-gray-700 mb-1">Alternate Phone
                        No</label>
                      <input type="tel" id="alternatePhoneNo" name="alternatePhoneNo"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm transition-all focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-600/10"
                  ...
                  <div class="grid grid-cols-3 gap-4">
                    ...
                    <div class="form-field">
                      <label for="emailAddress" class="block text-sm font-medium text-gray-700 mb-1">E-Mail
                        Address</label>
                ...
                <div class="space-y-4">
                  <div class="grid grid-cols-4 gap-4">
                    <div class="form-field">
                      ...
                      <input type="text" id="repSurname" name="repSurname"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm transition-all focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-600/10 uppercase"
                        placeholder="SURNAME" />
                    </div>
                    ...
                    <div class="form-field">
                      ...
                      <input type="text" id="repFirstName" name="repFirstName"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm transition-all focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-600/10 uppercase"
                        placeholder="FIRST NAME" />
                    </div>
                    ...
                    <div class="form-field">
                      ...
                      <input type="text" id="repMiddleName" name="repMiddleName"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm transition-all focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-600/10 uppercase"
                        placeholder="MIDDLE NAME" />
                    </div>
                  ...
                  <div class="grid grid-cols-2 gap-4">
                    <div class="form-field">
                      <label for="repRelationship" class="block text-sm font-medium text-gray-700 mb-1">Relationship to
                        Applicant/Designation</label>
                      <input type="text" id="repRelationship" name="repRelationship"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm transition-all focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-600/10 uppercase"
                    ...
                    <div class="form-field">
                      ...
                      <input type="tel" id="repPhoneNo" name="repPhoneNo"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm transition-all focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-600/10"
                        placeholder="Phone Number" />
                    </div>
                  </div>
            ...
            <div class="p-4 space-y-4">
              <div class="grid grid-cols-4 gap-4">
                <div class="form-field">
                  ...
                  <input type="text" id="titleHolderSurname" name="titleHolderSurname" required
                    class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm transition-all focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-600/10 uppercase"
                    placeholder="SURNAME" />
                ...
                <div class="form-field">
                  ...
                  <input type="text" id="titleHolderFirstName" name="titleHolderFirstName" required
                    class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm transition-all focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-600/10 uppercase"
                    placeholder="FIRST NAME" />
                ...
                <div class="form-field">
                  <label for="titleHolderMiddleName" class="block text-sm font-medium text-gray-700 mb-1">Other
                    Names</label>
                  <input type="text" id="titleHolderMiddleName" name="titleHolderMiddleName"
                    class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm transition-all focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-600/10 uppercase"
                    placeholder="MIDDLE NAME" />
                </div>
                ...
                <div class="form-field">
                  ...
                  <input type="text" id="titleHolderTitle" name="titleHolderTitle"
                    class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm transition-all focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-600/10 uppercase"
                    placeholder="TITLE" />
                </div>
              </div>
              ...
              <div class="form-field">
                ...
                <input type="text" id="cofoNumber" name="cofoNumber" required
                  class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm transition-all focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-600/10 uppercase"
              ...
              <div class="border-t pt-4">
                ...
                <div class="grid grid-cols-4 gap-4 mb-4">
                  <div class="form-field">
                    <label for="registrationNo" class="block text-sm font-medium text-gray-700 mb-1">Registration
                      No</label>
                  ...
                  <div class="form-field">
                    ...
                    <input type="text" id="registrationVolume" name="registrationVolume"
                      class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm transition-all focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-600/10"
                      placeholder="VOLUME" />
                  </div>
                  ...
                  <div class="form-field">
                    ...
                    <input type="text" id="registrationPage" name="registrationPage"
                      class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm transition-all focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-600/10"
                      placeholder="PAGE" />
                  </div>
                ...
                <div class="space-y-4">
                  <div class="form-field">
                    <label class="block text-sm font-medium text-gray-700 mb-2">
                      Plot Ownership: Is the Applicant the original owner of the Plot? <span
                  ...
                  <div id="ownership-details" class="space-y-4 border-l-4 border-blue-200 pl-4 hidden">
                    ...
                    <div class="form-field">
                      <label for="titleHolderName" class="block text-sm font-medium text-gray-700 mb-1">ii. Name of
                        Title Holder</label>
                      <input type="text" id="titleHolderName" name="titleHolderName"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm transition-all focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-600/10 uppercase"
                  ...
                  <div class="grid grid-cols-2 gap-4">
                    <div class="form-field">
                      <label for="commencementDate" class="block text-sm font-medium text-gray-700 mb-1">Commencement
                        Date</label>
                      <input type="date" id="commencementDate" name="commencementDate"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm transition-all focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-600/10" />
                    </div>

                    <div class="form-field">
                      <label for="grantTerm" class="block text-sm font-medium text-gray-700 mb-1">Grant Term</label>
                      <input type="text" id="grantTerm" name="grantTerm"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm transition-all focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-600/10"
          ...
          <div class="bg-white border border-gray-200 rounded-lg">
            ...
            <div class="p-4 space-y-4">
              ...
              <div id="encumbrance-reason" class="form-field hidden">
                <label for="encumbranceReason" class="block text-sm font-medium text-gray-700 mb-1">If yes, state the
                  reason(s):</label>
                <textarea id="encumbranceReason" name="encumbranceReason" rows="3"
                  class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm transition-all focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-600/10 uppercase"
                  placeholder="STATE REASON FOR ENCUMBRANCE"></textarea>
              </div>

              <div class="form-field">
                <label class="block text-sm font-medium text-gray-700 mb-2">
                  Is there a subsisting Mortgage on the Property Rights over the Plot? <span
                    class="text-red-500">*</span>
                </label>
                <div class="flex gap-4">
                  <label class="radio-item">
              ...
              <div id="mortgage-details" class="space-y-4 border-l-4 border-orange-200 pl-4 hidden">
                <div class="form-field">
                  <label for="mortgageeName" class="block text-sm font-medium text-gray-700 mb-1">Name of Mortgagee
                    Institution</label>
                  <input type="text" id="mortgageeName" name="mortgageeName"
                    class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm transition-all focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-600/10 uppercase"
                ...
                <div class="grid grid-cols-4 gap-4">
                  <div class="form-field">
                    <label for="mortgageRegistrationNo" class="block text-sm font-medium text-gray-700 mb-1">Mortgage
                      Registration No</label>
                    <input type="text" id="mortgageRegistrationNo" name="mortgageRegistrationNo"
                      class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm transition-all focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-600/10"
                      placeholder="REG NO" />
                  </div>
                  ...
                  <div class="form-field">
                    ...
                    <input type="text" id="mortgageVolume" name="mortgageVolume"
                      class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm transition-all focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-600/10"
                      placeholder="VOLUME" />
                  </div>
                  ...
                  <div class="form-field">
                    ...
                    <input type="text" id="mortgagePage" name="mortgagePage"
                      class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm transition-all focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-600/10"
                      placeholder="PAGE" />
                  </div>
                  ...
                  <div class="form-field">
                    ...
                    <input type="text" id="mortgageNumber" name="mortgageNumber"
                      class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm transition-all focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-600/10"
                      placeholder="NO" />
                  </div>
                </div>
            ...
            <div class="p-4 space-y-4">
              ...
              <div class="grid grid-cols-2 gap-4">
                <div class="form-field">
                  ...
                  <input type="text" id="layoutDistrict" name="layoutDistrict" required
                    class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm transition-all focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-600/10 uppercase"
            ...
            <div class="p-4 space-y-6">
              <div>
                ...
                <div class="grid grid-cols-3 gap-4">
                  ...
                  <div class="form-field">
                    <label for="receiptNo" class="block text-sm font-medium text-gray-700 mb-1">Receipt No/Teller
                      No</label>
              ...
              <div class="bg-gray-100 p-4 rounded-lg border border-gray-200">
                <h5 class="font-semibold mb-3 text-sm flex items-center gap-2">
                  <i data-lucide="info" class="h-4 w-4"></i>
                  System Metadata
                </h5>
                <div class="grid grid-cols-3 gap-4">
                  <div>
                    <label class="block text-[10px] font-bold text-gray-500 uppercase tracking-wider mb-1">Time
                      Generated</label>
                  ...
                  <div>
                    <label class="block text-[10px] font-bold text-gray-500 uppercase tracking-wider mb-1">Date
                      Generated</label>
                    <div class="text-xs font-bold text-gray-700">
                      {{ date('d-m-Y') }}
                    </div>
                  ...
                  <div>
                    <label class="block text-[10px] font-bold text-gray-500 uppercase tracking-wider mb-1">Generated
                      By</label>
                    <div class="text-xs font-bold text-gray-700">

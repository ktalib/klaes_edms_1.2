@if (request()->query('land_use') === 'Commercial' || request()->query('land_use') === 'Mixed' || request()->query('landuse') === 'Commercial' || request()->query('landuse') === 'Mixed')
<div class="mb-6">
    ...
    <div class="bg-gray-50 p-4 rounded-md grid grid-cols-4 gap-4">
        ...
        <input type="text" id="commercialTypeOthersInput" name="commercial_type"

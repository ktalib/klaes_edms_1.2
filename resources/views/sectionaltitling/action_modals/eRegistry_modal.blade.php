                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select class="w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-100" id="eRegistryFileLocation" name="eRegistryFileLocation">
                            <option value="">ST Registry</option>
                            <option value="DG">DG Office</option>
                ...
                <div class="flex flex-col gap-2 bg-gray-100 mt-4 px-4 py-3 rounded-b">
                    <div class="flex justify-between items-center">
                        <div class="flex gap-2">
                            ...
                            <button type="button" id="submitERegistry" class="flex items-center space-x-2 px-4 py-2 bg-green-500 text-white rounded-md shadow hover:bg-green-600 btn-disabled" disabled>
...
<!-- Lands Modal -->
 ...
 <script>
    ...
    function openERegistryModal(applicationId, fileNo, applicantType, applicantData) {
        ...
        // Disable submit button and form fields (except those that should be enabled)

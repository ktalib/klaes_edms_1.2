...
@endif
                                                    ...
                                                    @if(is_array($document) && isset($document['path']))
                                                        <div class="bg-gray-50 rounded-lg border border-gray-200 p-4">
                                                            ...
                                                            <div class="mt-3 flex justify-end">
                                                                <button
                                                                    onclick="viewDocument('{{ asset('storage/app/public/' . $document['path']) }}', '{{ $type }}')"
                            ...
                            <div class="mb-8 bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                                ...
                                <div class="p-5">
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                        @php
                                            $planningStatus = $application->planning_recommendation_status;
                                            $isSua = isset($application->is_sua_unit) && $application->is_sua_unit == 1;

                                            // Auto-approval logic for PUA (Parented Unit Application)
                                            // If mother application is approved, sub-application planning is auto-approved
                                            if (!$isSua && strtolower($application->mother_planning_status ?? '') === 'approved') {
                                        ...
                                        <div>
                                            ...
                                            <span
                                                class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium {{ $planningStatus === 'Approved' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800' }} mt-1">

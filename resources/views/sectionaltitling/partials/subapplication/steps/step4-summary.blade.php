...
<div class="form-section" id="step4">
    <div class="p-6">
        ...
        <div class="flex items-center mb-6">
            ...
            <div class="flex items-center mr-4">
                <div class="step-circle active-tab flex items-center justify-center cursor-pointer" onclick="goToStep(4)">4</div>
            </div>
        ...
        <div class="flex justify-between">
            <button type="button" class="px-4 py-2 text-gray-600 hover:text-gray-800" onclick="goToStep(3)">
                <i data-lucide="arrow-left" class="w-4 h-4 mr-2"></i> Previous
            </button>
            <button type="submit" class="px-6 py-2 bg-green-600 text-white rounded-md hover:bg-green-700" id="submitApplication">
                <i data-lucide="check" class="w-4 h-4 mr-2"></i> Submit Application
            </button>
        </div>
    </div>
</div>
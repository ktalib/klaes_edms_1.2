...
<div class="form-section" id="step2">
    <div class="p-6">
        ...
        <div class="flex items-center mb-6">
            ...
            <div class="flex items-center mr-4">
                <div class="step-circle active-tab flex items-center justify-center cursor-pointer" onclick="goToStep(2)">2</div>
            </div>
            <div class="flex items-center mr-4">
        ...
        <div class="flex justify-between">
            <button type="button" class="px-4 py-2 text-gray-600 hover:text-gray-800" onclick="goToStep(1)">
                <i data-lucide="arrow-left" class="w-4 h-4 mr-2"></i> Previous
            </button>
            <button type="button" class="px-6 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700" onclick="goToStep(3)">

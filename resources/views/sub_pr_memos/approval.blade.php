                ...
                <div class="max-w-4xl mx-auto bg-white shadow-md my-8 print-container">
                    ...
                    <div class="p-8">
                        ...
                        <div class="mb-8 space-y-2">
                            ...
                            <p class="font-semibold">RE: APPLICATION FOR PLANNING RECOMMENDATION APPROVAL IN RESPECT OF PLOT NO. <strong> {{ $motherApplication->property_plot_no ?? '' }} </strong></p>
                        </div>
                        ...
                        <div class="mb-8 border-b pb-4">
                            ...
                            <p class="mb-1"><span class="font-semibold">Plot Number:</span> <strong>{{ $motherApplication->property_plot_no ?? 'N/A' }}</strong></p>
                            <p class="mb-1"><span class="font-semibold">Block Number:</span> <strong>{{ $application->block_number ?? '' }}</strong></p>
                            <p class="mb-1"><span class="font-semibold">LGA:</span> <strong>{{ $motherApplication->property_lga ?? 'N/A' }}</strong></p>
                            <p class="mb-1"><span class="font-semibold">Unit No:</span> <strong>{{ $application->unit_number ?? 'N/A' }}</strong></p>
                        </div>
                        ...
                        <div class="space-y-6 mb-8">
                            ...
                            <div>
                                ...
                                <ul class="list-disc ml-8">
                                    <li>
                                    <strong>{{ $additionalObservations ?? 'No additional observations provided.' }}</strong>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="signature-section no-break" style="padding: 0.5rem 1.5rem;">

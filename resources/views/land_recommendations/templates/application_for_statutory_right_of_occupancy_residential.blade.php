...
<head>
  ...
  <title>Statutory Right of Occupancy (Residential) - {{ $record->file_number ?? '' }}</title>
  <style>
...
<div class="page">
  ...
  {{-- BODY --}}
  <div class="para">
    At page 1 is an application for statutory Right of Occupancy over GP No.
  ...
  <div class="para">
    The applicant acquired the GP No. <strong>{{ $record->plot_number ?? '...............' }}</strong> through the monetization policy of Government. The applicant has settled all appropriate payments as per clearance letter at page &nbsp;&nbsp;&nbsp;&nbsp; where it is confirmed that, the beneficiary has paid the sum of
    <strong>&#x20A6;{{ isset($record->premium) ? number_format($record->premium, 2) : '.................' }}</strong>
    ({{ $record->premium_words ?? '.....................................' }}) (as purchase price) with receipt No. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; copy attached a, b, c.
    ...
    ({{ $record->preparation_fees_words ?? '.....................................' }}) being payment for 5% purchasing price of GP vide page &nbsp;&nbsp;&nbsp;&nbsp; and triplicate receipt at back cover.
  </div>
  ...
  <ol class="rec-list">
    <li>
      Grant statutory Right of Occupancy No. <strong>{{ $record->file_number ?? 'RES/......./.......' }}</strong>

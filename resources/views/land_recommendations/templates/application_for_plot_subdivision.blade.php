...
<head>
  ...
  <title>Plot Subdivision Application - {{ $record->file_number ?? '' }}</title>
  <style>
...
<div class="page">
  ...
  <div class="dimension-table">
    ...
    @else
      ...
      <div class="dimension-row"><span class="dim-num">ii.</span><span class="dim-val">..............m x ..............m</span></div>
      <div class="dimension-row"><span class="dim-num">iii.</span><span class="dim-val">..............m x ..............m</span></div>
    @endif
  </div>
  ...
  <div class="rec-block">
    <div class="para">
      I. <strong>CONSIDER AND APPROVE</strong> the sub-division in respect <strong>{{ $record->file_number ?? '...............' }}</strong> over a piece of land situated at
      <strong>{{ $record->location ?? '...............' }}</strong>

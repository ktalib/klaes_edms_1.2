...
<div id="global-fileno-modal"
    ...
    <div class="bg-white rounded-lg shadow-xl w-full max-w-5xl max-h-[90vh] flex flex-col overflow-hidden"
        ...
        <!-- Modal Header -->
        <div class="relative px-6 py-4 bg-gradient-to-br from-blue-500 via-blue-600 to-indigo-700 text-white shrink-0">
        ...
        <div class="px-6 py-4 bg-gray-50 flex-1 overflow-y-auto">
            ...
            <div class="flex space-x-1 mb-4 bg-white p-1 rounded border border-gray-200">
                ...
                <button type="button"
                    class="fileno-tab-btn flex-1 px-4 py-3 text-sm font-medium rounded-md transition-all duration-200 text-gray-400 opacity-50 cursor-not-allowed"
                    data-tab="newkangis" disabled>
                    <div class="flex items-center justify-center space-x-2">
            ...
            <div class="tab-content-container">
                        ...
                        <div class="mb-3 space-y-4">
                            ...
                            <div>
                                ...
                                <select id="mls-file-type"
                                    ...
                                    <option value="lpcc_dciv">DCIV</option>
                                    <option value="gkn">Survey Registry</option>
                                </select>
                            </div>
                            ...
                            <div class="mls-type-fields hidden mt-2" data-type="sit">
                                <div class="grid grid-cols-2 gap-2">
                                    <div>
                                        <label class="block text-xs font-medium text-gray-700 mb-1">Year</label>
                                        <select id="mls-sit-year"
                                            class="w-full p-2 border border-gray-300 rounded year-select"
                                            data-placeholder="Select year">
                                            <option value="">Select year</option>
                                            @for($year = date('Y'); $year >= 1981; $year--)
                                                <option value="{{ $year }}" {{ $year == date('Y') ? 'selected' : '' }}>
                            ...
                            <div class="mls-type-fields hidden mt-2" data-type="old_mls">
                                <div>
                                    ...
                                    <input type="text" id="mls-old-serial"
                                        oninput="this.value = this.value.replace(/[^0-9]/g, '')"
                                        class="w-full p-2 border border-gray-300 rounded" placeholder="12345">
                                </div>
                            </div>
                                ...
                                <div class="grid grid-cols-2 gap-2">
                                    <div>
                                        ...
                                        <input type="text" id="mls-klaes-temp-prefix"
                                            class="w-full p-2 border border-gray-300 rounded" placeholder="TEMP"
                                            value="TEMP">
                                    </div>
                                    <div>
                                        <label class="block text-xs font-medium text-gray-700 mb-1">Serial
                                            Number</label>
                                        <input type="text" id="mls-klaes-temp-serial"
                                            oninput="this.value = this.value.replace(/[^0-9]/g, '')"
                                            class="w-full p-2 border border-gray-300 rounded" placeholder="00001">
                                    </div>
                                </div>
                            </div>

                            <!-- DCIV/LPCC Fields -->
                            <div class="mls-type-fields hidden mt-2" data-type="dciv lpcc lpcc_dciv">
                                <div class="grid grid-cols-3 gap-2">
                                    <div>
                                        <label class="block text-xs font-medium text-gray-700 mb-1">Prefix</label>
                                        <select id="mls-dciv-lpcc-prefix"
                                            class="w-full p-2 text-sm border border-gray-300 rounded">
                            ...
                            <!-- GKN Fields -->
                            <div class="mls-type-fields hidden mt-2" data-type="gkn">
                                <div class="grid grid-cols-2 gap-2">
                                    <div>
                                        <label class="block text-xs font-medium text-gray-700 mb-1">Prefix</label>
                                        <select id="mls-gkn-prefix"
                                            class="w-full p-2 text-sm border border-gray-300 rounded">
                                            <option value="GKN" selected>GKN</option>
                                        </select>
                                    </div>
                                    <div>
                                        <label class="block text-xs font-medium text-gray-700 mb-1">Sequential
                                            Number</label>
                                        <input type="text" id="mls-gkn-serial"
                                            oninput="this.value = this.value.replace(/[^0-9]/g, '')"
                                            class="w-full p-2 border border-gray-300 rounded" placeholder="1">
                                        <p class="text-xs text-gray-500 mt-1">
                                            Format: GKN-<strong>1</strong>, GKN-<strong>2</strong>, etc.
                                        </p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="fileno-tab-content hidden bg-white rounded p-4 border border-gray-200" data-tab="newkangis">
                    ...
                    <div class="flex p-1 bg-gray-100 rounded-lg mb-4">
                        <label class="flex-1 flex items-center justify-center cursor-pointer group">
                            <input type="radio" name="newkangis-input-method" value="smart" class="sr-only peer"
                                checked>
                            <span class="flex items-center space-x-2 px-4 py-2 rounded-md font-medium text-sm transition-all duration-200 
                    ...
                    <div class="newkangis-input-section" data-method="smart">
                        <div class="mb-4">
                            <label class="block text-sm font-medium text-gray-700 mb-2">Search Existing New KANGIS
                                Files</label>
...
@once
    ...
    <script>
        $(document).ready(function () {
            ...
            // Apply to all serial number inputs
            const serialInputs = [
                '#mls-serial',

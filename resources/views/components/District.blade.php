<div class="space-y-2" data-component="district-name">
    <label for="district" class="text-xs text-gray-600">District Name</label>
    <select id="district" name="district" class="form-input text-sm property-input" data-role="district-select">
    ...
    <input type="text" id="otherDistrict" class="form-input text-sm property-input mt-2 hidden"
        placeholder="Please specify other district name" data-role="district-other" data-name-target="district">
</div>
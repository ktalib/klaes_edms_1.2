<div class="space-y-2" data-component="street-name">
    <label for="streetName" class="text-xs text-gray-600">Street Name</label>
    <select id="streetName" name="streetName" class="form-input text-sm property-input" data-role="street-select">
        ...
        <optio n value="ZUNGERU ROAD">ZUNGERU ROAD</option>
            <option value="other">Other</option>
    </select>
    <input type="text" id="otherStreetName" class="form-input text-sm property-input mt-2 hidden"
        placeholder="Please specify other street name" data-role="street-other" data-name-target="streetName">
</div>
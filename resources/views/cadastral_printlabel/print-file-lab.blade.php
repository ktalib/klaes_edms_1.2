  ...
  <script>
    (function () {
      ...
      function createLabelNode(label, shelfMode = false) {
        ...
        primaryNumber.textContent = 'Cad:' + primaryText;
        numberGroup.appendChild(primaryNumber);

        // Second copy of the file number, also below the QR (italic).
        const primaryNumberDuplicate = document.createElement('div');
        primaryNumberDuplicate.className = 'file-number file-number--italic';
        primaryNumberDuplicate.textContent = 'Land:' + primaryText;
        numberGroup.appendChild(primaryNumberDuplicate);

-- ============================================================================
-- SuA Allocation Reference No — migration ledger (MYSQL / default connection)
--
...
--
-- Run this ONLY AFTER sua_allocation_reference_no_2026_08_22.sqlsrv.sql has
-- been applied successfully. Re-running is safe: nothing is inserted twice.
-- ============================================================================
...
FROM (
    SELECT '2026_08_22_100000_add_allocation_reference_no_to_st_file_numbers_table' AS migration
) AS t
...
FROM   migrations
WHERE  migration = '2026_08_22_100000_add_allocation_reference_no_to_st_file_numbers_table';
